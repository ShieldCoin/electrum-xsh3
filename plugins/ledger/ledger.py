...
from electrum_xsh import bitcoin, constants
from electrum_xsh.bitcoin import TYPE_ADDRESS, int_to_hex, var_int
...
from electrum_xsh.util import print_error, is_verbose, bfh, bh2u, versiontuple
...
MSG_NEEDS_FW_UPDATE_SEGWIT = _('Firmware version (or "SHIELD" app) too old for Segwit support. Please update at') + \
                      ' https://www.ledgerwallet.com'
        ...
        if not self.preflightDone:
            try:
                ...
                if (e.sw == 0x6d00 or e.sw == 0x6700):
                    raise Exception(_("Device not in SHIELD mode")) from e
                raise e
        ...
        try:
            ...
            if segwitTransaction:
                self.get_client().startUntrustedTransaction(True, inputIndex,
                                                            chipInputs, redeemScripts[inputIndex], 0x04)
                if changePath:
                ...
                while inputIndex < len(inputs):
                    ...
                    self.get_client().startUntrustedTransaction(False, 0,
                                                            singleInput, redeemScripts[inputIndex], 0x04)
