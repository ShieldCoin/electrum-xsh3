...
from electrum_xsh.util import format_satoshis, set_verbosity
from electrum_xsh.bitcoin import is_address, COIN, TYPE_ADDRESS
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print("Wallet not found. try 'electrum-xsh create'")
            exit()
    ...
    def do_send(self):
        if not is_address(self.str_recipient):
            print(_('Invalid SHIELD address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-xsh setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-xsh setconfig' to change your settings")
        return True
