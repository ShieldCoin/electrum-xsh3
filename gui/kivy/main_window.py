...
from electrum_xsh.bitcoin import TYPE_ADDRESS
from electrum_xsh import WalletStorage, Wallet
from electrum_xsh_gui.kivy.i18n import _
from electrum_xsh.paymentrequest import InvoiceStore
from electrum_xsh.util import profiler, InvalidPassword
from electrum_xsh.plugins import run_hook
from electrum_xsh.util import format_satoshis, format_satoshis_plain
from electrum_xsh.paymentrequest import PR_UNPAID, PR_PAID, PR_UNKNOWN, PR_EXPIRED
...
#Factory.register('InstallWizard', module='electrum_xsh_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_xsh_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_xsh_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_xsh_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_xsh_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_xsh_gui.kivy.uix.screens')
...
from electrum_xsh.util import (base_units, NoDynamicFeeEstimates, decimal_point_to_base_unit_name,
...
class ElectrumWindow(App):
    ...
    def on_qr(self, data):
        from electrum_xsh.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_xsh.util import bh2u
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_xsh.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_xsh_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_xsh_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_xsh_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_xsh_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-xsh.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-XSH', message,
                            app_icon=icon, app_name='Electrum-XSH')
        except ImportError:
